...
const MissingOEQDisplay = ({ assignment, period }) => {
  ...
  return (
    <div style={{ marginLeft: '5%' }}>
      {assignment.assignmentType}: {assignment.readingSections} - Assigned on{' '}
      {formattedDate}:
      <ul>
        <li>
          Read pages: {assignment.readingPages}: {assignment.readingSections}{' '}
          and answer the following open ended question:
          <ul>
            <li> {question}</li>
          </ul>
        </li>
