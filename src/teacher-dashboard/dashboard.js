    ...
    <>
      {!me ? (
        ...
        <div id="test">
          <header
            className="Header"
            style={{ borderBottom: '3px solid var(--white)' }}
          >
            ...
            >
              <Link
                style={{ margin: '1%' }}
                to={`${match.url}/roster-view/A_12`}
              >
                GradeBook
              </Link>
              <Link
                style={{ margin: '1%' }}
                to={`${match.url}/classroom/class-period-selector`}
              >
                Classroom
              </Link>
              <Link
                style={{ margin: '1%' }}
                to={`${match.url}/school-day/ClassManager/A_12`}
              >
                Courses
              </Link>
          ...
          >
            <Route
              path={`${match.path}/roster-view/`}
              component={RosterNavBar}
            />
            <Route
              path={`${match.path}/roster-view/:periodName`}
              component={Rosters}
            />
          </div>
          ...
          <Route
            exact
            path="/dashboard/roster-view/allStudent"
            component={AllStudentRoster}
          />
          <Route
            exact
          ...
          <Route
            ...
            component={StudentInfoLoader}
          />

          <Route path={`${match.path}/classroom/`} component={Classes} />
          <Route
            path={`${match.path}/lesson-planner/`}
